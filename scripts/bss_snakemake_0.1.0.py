...
rmd_path = "/scripts"
rmd_file = "bss_summary_0.1.0.Rmd"
rmd_local = "script_" + rmd_file


## new indices won't be persistent --- keep in host rather than Docker?
ref_folder = "/refs/ref_100b"
ref_file = ref_folder + "/bss_ref_100b.fa" ## used by R
...
rule bismark_hs:
    ...
    shell:
        "{bismark_path}/bismark --output_dir bismark_bam --temp_dir bismark_temp --non_directional --hisat2 --path_to_hisat2 {hisat2_path} --samtools_path {samtools_path} --local --prefix local --genome {input.ix} -q {input.fq}"
